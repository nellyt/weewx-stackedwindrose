    ...
    def genWindRosePlots(self):
        ...
        for span in self.image_dict.sections:
            ...
            for plot in self.image_dict[span].sections:
                ...
                # Get vector_color, options : none, hex color
                # Default to red
                if p_options.has_key('vector_color'):
                    if p_options['vector_color'] == 'none':
                        vector_color = "none"
                    else :
                        vector_color = int(p_options['vector_color'],0)
                else:
                    vector_color = 0x0000FF
                # Get end_color, options : none, hex color
                # Default to none, which is same as the rest of the points
                if p_options.has_key('end_color'):
                    if p_options['end_color'] == 'none':
                        end_color = "none"
                    else :
                        end_color = int(p_options['end_color'],0)
                else:
                    end_color = 'none'
                        ...
                        for layer in range(3):
                            ...
                            for i in range(0, samples):
                                ...
                                if (speed_vec[0][i] is None) or (dir_vec[0][i] is None) or (speed_vec[0][i] == 0.0):
                                    continue
                                if i == samples-1:
                                # TODO This delta looks wrong when i=samples -1 ???
                                ...
                                if layer == 0:
                                    ...
                                    # 2nd and 3rd pass we do the dots and lines
                                    ...
                                    if layer == 2:
                                        ...
                                        if i == samples-1 :
                                            # This is the last point so make it different colour if needed
                                            if end_color != 'none' :
                                        ...
                                        # option : straight, radial, none for trail
